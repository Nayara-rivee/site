            ...
            <div class="row gx-3 menu-lateral ">
                <div class="col-4 ">
                    <div class="list-group">
                        ...
                        <a href="src/pages/contatoscliente.php" class="list-group-item list-group-item-action ">
                        ...
                        <a href="src/pages/itensfavoritoscliente.php" class="list-group-item list-group-item-action">
                        ...
                        <a href="src/pages/src/pages/login.php" class="list-group-item list-group-item-action">
